...
/**
 * @title ZaseonSP1Verifier
 * @notice Verifier for SP1 RISC-V zkVM proofs
 * @dev Supports Succinct's SP1 proving system for Zaseon
 ...
 * @custom:deprecated SP1 verification is now handled by ZaseonMultiProver (contracts/verifiers/ZaseonMultiProver.sol)
 *   which implements 2-of-3 consensus across Noir, SP1, and Jolt. This standalone verifier is retained
 *   for reference only. Use ZaseonMultiProver + ZaseonUniversalVerifier for new integrations.
 */
contract ZaseonSP1Verifier is Ownable {
    // ============================================
    // Types
    // ============================================
