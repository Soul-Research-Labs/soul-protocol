...
/**
 * @title PILSP1Verifier
 * @notice Verifier for SP1 RISC-V zkVM proofs
 * @dev Supports Succinct's SP1 proving system for PIL
 */
contract PILSP1Verifier is Ownable {
    // ============================================
    // Types
    // ============================================
