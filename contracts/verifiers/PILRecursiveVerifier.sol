...
/**
 * @title PILRecursiveVerifier
 * @notice Verifies aggregated recursive proofs for PIL protocol
 * @dev Supports both single proofs (backward compatible) and aggregated proofs
 */
contract PILRecursiveVerifier is Ownable, ReentrancyGuard, Pausable {
    // ============================================
    // Types
    // ============================================
