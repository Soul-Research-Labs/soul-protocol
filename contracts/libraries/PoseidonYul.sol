...
library PoseidonYul {
    ...
    function hash2(uint256 input1, uint256 input2) internal pure returns (uint256 result) {
        assembly {
            ...
            let c0 := 14397397413755236225575615486459253198602422701513067526754101844196324375522
            let c1 := 10405129301473404666785234951972711717481302463898292859783056520670200613128
            let c2 := 5179144822360023508491245509308555580251733042407187134628755730783052214509
            let c3 := 9132640374240188374542843306219594180154739721841249568925550236430986592615
            let c4 := 20360807315276763881209958738450444293273549928693737723235350358403012458514
            let c5 := 17933600965499023212689924809448543050840131883187652471064418452962948061619
            let c6 := 3636213416533737411392076250708419981662897009810345015164671602334517041153
            let c7 := 2008540005368330234524962342006691994500273283000229509835662097352946198608
