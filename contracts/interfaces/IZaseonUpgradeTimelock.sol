...
/**
 * @title IZaseonUpgradeTimelock
 * @author ZASEON
 * @notice Interface for the ZASEON upgrade‐specific timelock controller.
 * @dev Mirrors the custom functionality exposed by ZaseonUpgradeTimelock on top of
 *      OpenZeppelin's TimelockController.  Contracts that interact with the
 *      timelock (e.g. ZaseonGovernor, deployment scripts) should depend on this
 *      interface rather than the concrete implementation.
 */
interface IZaseonUpgradeTimelock {
    /*//////////////////////////////////////////////////////////////
                                STRUCTS
    //////////////////////////////////////////////////////////////*/
