...
/**
 * @title ZaseonAtomicSwapV2Upgradeable
 * @author ZASEON
 * @notice UUPS-upgradeable version of ZaseonAtomicSwapV2 for proxy deployments
 ...
 *
 * @custom:oz-upgrades-from ZaseonAtomicSwapV2
 */
contract ZaseonAtomicSwapV2Upgradeable is
    Initializable,
    ...
    SecurityModule
{
    ...
    /**
     * @notice Initialize the upgradeable ZaseonAtomicSwapV2
