...
/**
 * @title ZaseonProtocolHubUpgradeable
 * @author ZASEON
 * @notice UUPS-upgradeable central registry and integration hub for all ZASEON components
 * @dev Routes requests to appropriate modules and maintains component registrations.
 *      Upgradeable variant of ZaseonProtocolHub using the UUPS proxy pattern.
 * @custom:oz-upgrades-from ZaseonProtocolHub
 */
contract ZaseonProtocolHubUpgradeable is
    Initializable,
    IZaseonProtocolHub,
