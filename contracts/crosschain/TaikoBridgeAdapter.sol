 ...
 */
contract TaikoBridgeAdapter is
    IBridgeAdapter,
    AccessControl,
    ReentrancyGuard,
    Pausable
{
        ...
        returns (bytes32 messageId)
    {
        ...
        messageId = keccak256(abi.encode(signal, msg.sender, nonce));
        ...
        emit MessageSent(messageId, targetAddress, nonce, signal);
        return messageId;
    }
    ...
    function estimateFee(
        ...
        return 0; // Taiko uses based sequencing — no bridge fee
    }
