    ...
    Pausable
{
    ...
    /// @notice Emitted when a message is sent to Mode L2
    /// @param messageHash The unique hash identifying this message
    /// @param target The target contract address on Mode L2
    ...
    /// @param modePortal The new OptimismPortal address for Mode
    ...
    /// @param zaseonHubL2 The new Zaseon Hub address on Mode L2
    ...
    /// @param _crossDomainMessenger L1CrossDomainMessenger address for Mode
    /// @param _modePortal OptimismPortal address for Mode
    /// @param _outputOracle L2OutputOracle address for Mode
    ...
    /// @param _zaseonHubL2 Address of the Zaseon Hub on Mode L2
