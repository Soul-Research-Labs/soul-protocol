...
import {IZaseonL2Messenger} from "../interfaces/IZaseonL2Messenger.sol";

/// @title ZaseonL2Messenger
/// @author ZASEON
...
/// ┌─────────────────────────────────────────────────────────────────────────┐
/// │                    Zaseon Cross-L2 Privacy Messaging                       │
/// ├─────────────────────────────────────────────────────────────────────────┤
/// │                                                                          │
/// │   L2-A (Arbitrum)              L1 Relay              L2-B (Optimism)    │
/// │   ┌────────────┐           ┌───────────┐           ┌────────────┐       │
/// │   │ ZaseonL2     │           │ Proof     │           │ ZaseonL2     │       │
...
contract ZaseonL2Messenger is ReentrancyGuard, AccessControl, IZaseonL2Messenger {
    ...
    /// @notice Initialize the Zaseon L2 messenger
