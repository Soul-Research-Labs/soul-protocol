...
const CONTRACT_ADDRESS = __ENV.CONTRACT || '0x40eaa5de0c6497c8943c967b42799cb092c26adc';
...
function generateProofData() {
  return {
    ...
    proofData: '0x' + randomBytes(256).map(b => b.toString(16).padStart(2, '0')).join(''),
    publicInputs: '0x' + randomBytes(64).map(b => b.toString(16).padStart(2, '0')).join(''),
...
function encodeProofSubmission(proof) {
  ...
  const signature = '0x12345678'; // Placeholder
