...
/**
 * Client for Zaseonv2Orchestrator contract
 * Coordinates operations across all Zaseon v2 primitives
 */
export class Zaseonv2OrchestratorClient {
  public contract: ViemContract;
  private publicClient: PublicClient;
  private walletClient?: WalletClient;
...
/**
 * Factory for creating Zaseon v2 primitive clients
 */
export class Zaseonv2ClientFactory {
  ...
  /**
   * Create Zaseonv2Orchestrator client
   */
  orchestrator(): Zaseonv2OrchestratorClient {
    if (!this.config.orchestrator) {
      throw new Error("Orchestrator address not configured");
    }
    return new Zaseonv2OrchestratorClient(
   ...
   */
  getOrchestrator(): Zaseonv2OrchestratorClient {
