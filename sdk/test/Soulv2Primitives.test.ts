...
} from "../src/client/Soulv2Primitives";

describe("Soulv2Primitives SDK Verification", function () {
    this.timeout(120000);

    let publicClient: any;
    let walletClient: any;
    let factory: Soulv2ClientFactory;
    ...
    before(async function () {
        ...
        factory = new Soulv2ClientFactory(config, publicClient, walletClient);
