...
- `ScrollBridgeAdapter`, `LineaBridgeAdapter`, `zkSyncBridgeAdapter` → `contracts/crosschain/`

> **Note:** `PolygonZkEVMBridgeAdapter` is on the roadmap but not yet implemented.
