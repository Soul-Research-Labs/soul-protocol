...
/**
 * @title ZaseonCrossChainRelayExtendedTest
 ...
 *         Supplements the existing ZaseonCrossChainRelayTest.
 */
contract ZaseonCrossChainRelayExtendedTest is Test {
    ...
    function test_relayProof_revert_failingBridge() public {
        ...
        ZaseonCrossChainRelay.ChainConfig memory failConfig = ZaseonCrossChainRelay
            .ChainConfig({
                proofHub: address(proofHub),
