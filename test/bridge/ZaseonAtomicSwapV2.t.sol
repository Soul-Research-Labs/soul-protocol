...
import "../../contracts/bridge/ZaseonAtomicSwapV2.sol";
...
contract ZaseonAtomicSwapV2Test is Test {
    ZaseonAtomicSwapV2 public swap;
    ...
    function setUp() public {
        swap = new ZaseonAtomicSwapV2(feeRecipient);
        token = new MockERC20();
    ...
    function test_constructor_revertsZeroAddress() public {
        vm.expectRevert(ZaseonAtomicSwapV2.ZeroAddress.selector);
        new ZaseonAtomicSwapV2(address(0));
    }
    ...
    function test_createSwapETH_success() public {
        ...
        (
            ...
            bytes32 hl,
            uint256 tl,
            ZaseonAtomicSwapV2.SwapStatus status,
            bytes32 comm
        ) = swap.swaps(swapId);
        ...
        assertEq(uint8(status), uint8(ZaseonAtomicSwapV2.SwapStatus.Created));
    ...
    function test_createSwapETH_revertsZeroAmount() public {
        vm.prank(alice);
        vm.expectRevert(ZaseonAtomicSwapV2.InvalidAmount.selector);
        swap.createSwapETH{value: 0}(bob, hashLock, timeLock, commitment);
    }

    function test_createSwapETH_revertsZeroRecipient() public {
        vm.prank(alice);
        vm.expectRevert(ZaseonAtomicSwapV2.InvalidRecipient.selector);
    ...
    function test_createSwapETH_revertsZeroHashLock() public {
        vm.prank(alice);
        vm.expectRevert(ZaseonAtomicSwapV2.InvalidHashLock.selector);
        swap.createSwapETH{value: 1 ether}(
            bob,
            bytes32(0),
            timeLock,
    ...
    function test_createSwapETH_revertsTimeLockTooShort() public {
        vm.prank(alice);
        vm.expectRevert(ZaseonAtomicSwapV2.InvalidTimeLock.selector);
        swap.createSwapETH{value: 1 ether}(
            bob,
            hashLock,
            30 minutes,
    ...
    function test_createSwapETH_revertsDuplicateHashLock() public {
        ...
        vm.expectRevert(ZaseonAtomicSwapV2.SwapAlreadyExists.selector);
        swap.createSwapETH{value: 1 ether}(bob, hashLock, timeLock, commitment);
        vm.stopPrank();
    }
    ...
    function test_commitRevealClaim_success() public {
        ...
        (, , , , , , ZaseonAtomicSwapV2.SwapStatus status, ) = swap.swaps(swapId);
        assertEq(uint8(status), uint8(ZaseonAtomicSwapV2.SwapStatus.Claimed));
    }
    ...
    function test_revealClaim_revertsWithoutCommit() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ZaseonAtomicSwapV2.InvalidCommitHash.selector);
    ...
    function test_revealClaim_revertsCommitTooRecent() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ZaseonAtomicSwapV2.CommitTooRecent.selector);
        swap.revealClaim(swapId, secret, salt);
    }
    ...
    function test_revealClaim_revertsWrongSecret() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ZaseonAtomicSwapV2.InvalidSecret.selector);
    ...
    function test_legacyClaim_revertsNotRecipient() public {
        ...
        vm.expectRevert(ZaseonAtomicSwapV2.UseCommitReveal.selector);
        swap.claim(swapId, secret);
    }
    ...
    function test_refund_afterExpiry() public {
        ...
        (, , , , , , ZaseonAtomicSwapV2.SwapStatus status, ) = swap.swaps(swapId);
        assertEq(uint8(status), uint8(ZaseonAtomicSwapV2.SwapStatus.Refunded));
    }
    ...
    function test_refund_revertsBeforeExpiry() public {
        ...
        vm.expectRevert(ZaseonAtomicSwapV2.SwapNotExpired.selector);
        swap.refund(swapId);
    }
    ...
    function test_refund_revertsAlreadyClaimed() public {
        ...
        vm.warp(block.timestamp + timeLock + 1);
        vm.expectRevert(ZaseonAtomicSwapV2.SwapNotPending.selector);
        swap.refund(swapId);
    }
    ...
    function test_getSwapByHashLock() public {
        ...
        ZaseonAtomicSwapV2.Swap memory s = swap.getSwapByHashLock(hashLock);
    ...
    function test_feeWithdrawal_revertsBeforeTimelock() public {
        ...
        vm.expectRevert(ZaseonAtomicSwapV2.WithdrawalNotReady.selector);
        swap.executeFeeWithdrawal(address(0), withdrawalId);
    }
    ...
    function test_commitClaim_revertsAfterExpiry() public {
        ...
        vm.prank(bob);
        vm.expectRevert(ZaseonAtomicSwapV2.SwapExpired.selector);
        swap.commitClaim(swapId, commitHash);
    }
