...
contract UnifiedNullifierManagerTest is Test {
    ...
    function test_initialize_revertOnZeroAddress() public {
        ...
        vm.expectRevert(IUnifiedNullifierManager.ZeroAddress.selector);
        new ERC1967Proxy(
            address(newImpl),
    ...
    function test_initialize_defaultChains() public view {
        ...
        IUnifiedNullifierManager.ChainDomain memory arb = manager
            .getChainDomain(42_161);
        assertTrue(arb.isActive);
        assertEq(
            uint256(arb.chainType),
            uint256(IUnifiedNullifierManager.ChainType.EVM)
        );

        IUnifiedNullifierManager.ChainDomain memory monero = manager
            .getChainDomain(900_001);
        assertTrue(monero.isActive);
        assertEq(
            uint256(monero.chainType),
            uint256(IUnifiedNullifierManager.ChainType.PRIVACY)
        );
    }
    ...
    function test_registerChainDomain() public {
        ...
        manager.registerChainDomain(
            newChainId,
            IUnifiedNullifierManager.ChainType.EVM,
            tag,
            address(0xADA)
        );

        IUnifiedNullifierManager.ChainDomain memory domain = manager
    ...
    function test_registerNullifier() public {
        ...
        IUnifiedNullifierManager.NullifierRecord memory record = manager
        ...
        assertEq(
            ...
            uint256(IUnifiedNullifierManager.NullifierStatus.REGISTERED)
        );
    ...
    function test_registerNullifier_revertOnDuplicate() public {
        ...
        vm.expectRevert(
            IUnifiedNullifierManager.NullifierAlreadyExists.selector
        );
        manager.registerNullifier(
            nullifier,
            keccak256("c2"),
    ...
    function test_registerNullifier_revertOnInactiveChain() public {
        vm.expectRevert(
            IUnifiedNullifierManager.ChainDomainNotRegistered.selector
        );
        manager.registerNullifier(
            keccak256("x"),
            keccak256("c"),
    ...
    function test_spendNullifier_revertOnUnknown() public {
        vm.expectRevert(IUnifiedNullifierManager.NullifierNotFound.selector);
    ...
    function test_spendNullifier_revertOnExpired() public {
        ...
        manager.registerNullifier(
            ...
            keccak256("c"),
            42_161,
            IUnifiedNullifierManager.NullifierType.TIME_BOUND,
            expiry
        );

        vm.warp(expiry + 1);
        vm.expectRevert(IUnifiedNullifierManager.NullifierExpired.selector);
        manager.spendNullifier(nullifier);
    }
    ...
    function test_createCrossDomainBinding_revertOnInvalidProof() public {
        ...
        vm.expectRevert(IUnifiedNullifierManager.InvalidProof.selector);
    ...
    function test_processBatch_revertOnEmpty() public {
        ...
        vm.expectRevert(IUnifiedNullifierManager.InvalidBatchSize.selector);
