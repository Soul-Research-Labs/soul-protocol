...
import {ZaseonMultiProver} from "../../contracts/verifiers/ZaseonMultiProver.sol";
import {IZaseonMultiProver} from "../../contracts/interfaces/IZaseonMultiProver.sol";
...
contract ZaseonMultiProverTest is Test {
    ZaseonMultiProver public prover;
    ...
    function test_Constructor_DefaultProversActive() public view {
        IZaseonMultiProver.ProverSystem[] memory active = prover
            .getActiveProvers();
    ...
    function test_RegisterProver() public {
        ...
        prover.registerProver(
            IZaseonMultiProver.ProverSystem.HALO2,
            address(mockPass),
            2
        );
    ...
    function test_RegisterProver_RevertZeroWeight() public {
        vm.prank(operator);
        vm.expectRevert(ZaseonMultiProver.InvalidProverConfig.selector);
        prover.registerProver(
            IZaseonMultiProver.ProverSystem.HALO2,
            address(mockPass),
            0
    ...
    function test_RegisterProver_UpdateExisting() public {
        ...
        vm.prank(operator);
        prover.registerProver(
            IZaseonMultiProver.ProverSystem.NOIR,
            address(mockPass),
            3
        );
    ...
    function test_DeactivateProver() public {
        vm.prank(operator);
        prover.deactivateProver(IZaseonMultiProver.ProverSystem.BINIUS);
    ...
    function test_DeactivateProver_RevertNotOperator() public {
        vm.prank(submitter1);
        vm.expectRevert();
        prover.deactivateProver(IZaseonMultiProver.ProverSystem.NOIR);
    }
    ...
    function test_SubmitProof() public {
        ...
        IZaseonMultiProver.VerificationResult memory result = prover
    ...
    function test_SubmitProof_RevertInactiveProver() public {
        ...
        vm.prank(submitter1);
        vm.expectRevert(ZaseonMultiProver.ProverNotActive.selector);
        prover.submitProof(
            proofId,
            inputsHash,
            IZaseonMultiProver.ProverSystem.NOIR,
    ...
    function test_SubmitProof_RevertDuplicateSubmission() public {
        ...
        vm.prank(submitter1);
        vm.expectRevert(ZaseonMultiProver.ProofAlreadySubmitted.selector);
        prover.submitProof(
            proofId,
            inputsHash,
            IZaseonMultiProver.ProverSystem.NOIR,
    ...
    function test_ConsensusReached_TwoOfFour() public {
        ...
        prover.registerProver(
            IZaseonMultiProver.ProverSystem.SP1,
            address(mockPass),
            1
        );
        vm.stopPrank();
    ...
    function test_SubmitMultipleProofs() public {
        ...
        IZaseonMultiProver.ProverSystem[]
            memory systems = new IZaseonMultiProver.ProverSystem[](2);
        systems[0] = IZaseonMultiProver.ProverSystem.NOIR;
        systems[1] = IZaseonMultiProver.ProverSystem.SP1;
    ...
    function test_FinalizeProof_RevertBeforeTimeout() public {
        ...
        vm.prank(submitter1);
        vm.expectRevert(ZaseonMultiProver.ProofTimedOut.selector);
        prover.finalizeProof(proofId);
    }

    function test_FinalizeProof_RevertNonexistent() public {
        vm.expectRevert(ZaseonMultiProver.ProofNotFound.selector);
