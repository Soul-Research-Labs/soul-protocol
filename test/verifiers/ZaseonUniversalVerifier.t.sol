...
contract ZaseonUniversalVerifierTest is Test {
    ZaseonUniversalVerifier public verifier;
    ...
    function setUp() public {
        ...
        verifier = new ZaseonUniversalVerifier();
        ...
        verifier.registerVerifier(
            ZaseonUniversalVerifier.ProofSystem.Groth16,
            address(groth16Verifier),
            300_000
        );
        verifier.registerVerifier(
            ZaseonUniversalVerifier.ProofSystem.Noir,
            address(noirVerifier),
            400_000
        );
        verifier.registerVerifier(
            ZaseonUniversalVerifier.ProofSystem.SP1,
            address(sp1Verifier),
            500_000
        );
    }
    ...
    ) internal pure returns (ZaseonUniversalVerifier.UniversalProof memory) {
        return
            ZaseonUniversalVerifier.UniversalProof({
                system: ZaseonUniversalVerifier.ProofSystem.Noir,
    ...
    function _makeSP1Proof(
        ...
        return
            ZaseonUniversalVerifier.UniversalProof({
                system: ZaseonUniversalVerifier.ProofSystem.SP1,
                vkeyOrCircuitHash: vkey,
                publicInputsHash: keccak256(publicInputs),
                proof: hex"cafe"
            });
    ...
    function test_RegisterVerifier() public view {
        ZaseonUniversalVerifier.VerifierConfig memory config = verifier
            .getVerifier(ZaseonUniversalVerifier.ProofSystem.Groth16);
    ...
    function test_RegisterVerifier_EmitsEvent() public {
        ...
        emit ZaseonUniversalVerifier.VerifierRegistered(
            ZaseonUniversalVerifier.ProofSystem.Plonk,
    ...
    function test_RegisterVerifier_RevertZeroAddress() public {
        vm.expectRevert(ZaseonUniversalVerifier.InvalidVerifier.selector);
        verifier.registerVerifier(
            ZaseonUniversalVerifier.ProofSystem.Plonk,
            address(0),
            200_000
    ...
    function test_RegisterVerifier_RevertInvalidGasLimit() public {
        ...
        ZaseonUniversalVerifier.VerifierConfig memory config = verifier
            .getVerifier(ZaseonUniversalVerifier.ProofSystem.Plonk);
        assertEq(config.gasLimit, verifier.defaultGasLimit());
    }

    function test_DeactivateVerifier() public {
        verifier.deactivateVerifier(ZaseonUniversalVerifier.ProofSystem.Groth16);
    ...
    function test_DeactivateVerifier_EmitsEvent() public {
        ...
        emit ZaseonUniversalVerifier.VerifierDeactivated(
            ZaseonUniversalVerifier.ProofSystem.Noir
        );
        verifier.deactivateVerifier(ZaseonUniversalVerifier.ProofSystem.Noir);
    }
    ...
    function test_UpdateGasLimit() public {
        ...
        ZaseonUniversalVerifier.VerifierConfig memory config = verifier
            .getVerifier(ZaseonUniversalVerifier.ProofSystem.Noir);
    ...
    function test_Verify_Noir() public {
        ...
        ZaseonUniversalVerifier.UniversalProof memory proof = _makeNoirProof(
            vkey,
            publicInputs
        );
    ...
    function test_Verify_SP1() public {
        ...
        ZaseonUniversalVerifier.UniversalProof memory proof = _makeSP1Proof(
            vkey,
            publicInputs
        );
    ...
    function test_Verify_RevertAlreadyVerified() public {
        ...
        vm.expectRevert(ZaseonUniversalVerifier.AlreadyVerified.selector);
        verifier.verify(proof, publicInputs);
    }
    ...
    function test_Verify_RevertInactiveVerifier() public {
        ...
        vm.expectRevert(ZaseonUniversalVerifier.VerifierNotActive.selector);
        verifier.verify(proof, publicInputs);
    }
    ...
    function test_Verify_RevertUnregisteredVerifier() public {
        ...
        ZaseonUniversalVerifier.UniversalProof memory proof = ZaseonUniversalVerifier
            .UniversalProof({
                system: ZaseonUniversalVerifier.ProofSystem.Plonk, // Not registered
    ...
    function test_Verify_RevertPublicInputsMismatch() public {
        ...
        vm.expectRevert(ZaseonUniversalVerifier.PublicInputsMismatch.selector);
    ...
    function test_BatchVerify() public {
        ZaseonUniversalVerifier.UniversalProof[]
            memory proofs = new ZaseonUniversalVerifier.UniversalProof[](2);
    ...
    function test_BatchVerify_RevertLengthMismatch() public {
        ...
        vm.expectRevert(ZaseonUniversalVerifier.LengthMismatch.selector);
    ...
    function test_GetVerifier_Unregistered() public view {
        ZaseonUniversalVerifier.VerifierConfig memory config = verifier
            .getVerifier(ZaseonUniversalVerifier.ProofSystem.Recursive);
    ...
    function test_GetStats() public view {
        (
            ZaseonUniversalVerifier.ProofSystem[] memory systems,
    ...
    function testFuzz_Verify_UniqueProofs(bytes32 vkey, bytes16 salt) public {
        ...
        ZaseonUniversalVerifier.UniversalProof
            memory proof = ZaseonUniversalVerifier.UniversalProof({
                system: ZaseonUniversalVerifier.ProofSystem.Noir,
                vkeyOrCircuitHash: vkey,
                publicInputsHash: keccak256(publicInputs),
