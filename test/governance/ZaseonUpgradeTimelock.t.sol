...
import {IZaseonUpgradeTimelock} from "../../contracts/interfaces/IZaseonUpgradeTimelock.sol";

/// @title ZaseonUpgradeTimelockTest
/// @notice Comprehensive unit tests for ZaseonUpgradeTimelock
contract ZaseonUpgradeTimelockTest is Test {
    ...
    function setUp() public {
        ...
        timelock = new ZaseonUpgradeTimelock(1, proposers, executors, admin);
    }
    ...
    function test_ConstructorRoles() public view {
        // Admin roles from ZaseonUpgradeTimelock constructor
    ...
    function test_ProposeStandardUpgrade() public {
        ...
        IZaseonUpgradeTimelock.UpgradeProposal memory p = timelock.getProposal(
            opId
        );
    ...
    function test_ProposeStandardUpgradeEmitsEvents() public {
        ...
        emit IZaseonUpgradeTimelock.UpgradeProposed(
    ...
    function test_RevertEmergencyUpgradeWithoutEmergencyMode() public {
        vm.prank(admin);
        vm.expectRevert(IZaseonUpgradeTimelock.NotInEmergencyMode.selector);
    ...
    function test_RevertProposeUpgradeFrozenTarget() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IZaseonUpgradeTimelock.UpgradesFrozen.selector,
                target
            )
        );
    ...
    function test_RevertDoubleSign() public {
        ...
        vm.prank(admin);
        vm.expectRevert(IZaseonUpgradeTimelock.AlreadySigned.selector);
        timelock.signUpgrade(opId);
    }
    ...
    function test_RevertExecuteInsufficientSignatures() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IZaseonUpgradeTimelock.InsufficientSignatures.selector,
                1,
                2
            )
        );
    ...
    function test_EnableEmergencyMode() public {
        ...
        emit IZaseonUpgradeTimelock.EmergencyModeEnabled(admin);
        timelock.enableEmergencyMode();
    ...
    function test_DisableEmergencyMode() public {
        ...
        vm.prank(admin);
        vm.expectEmit(true, false, false, false);
        emit IZaseonUpgradeTimelock.EmergencyModeDisabled(admin);
    ...
    function test_SetUpgradeFrozen() public {
        ...
        emit IZaseonUpgradeTimelock.UpgradeFrozen(target, true);
        timelock.setUpgradeFrozen(target, true);
    ...
    function test_ProposeMinSignatures_Increase_Instant() public {
        ...
        emit IZaseonUpgradeTimelock.MinSignaturesUpdated(2, 3);
    ...
    function test_ConfirmMinSignatures_AfterDelay() public {
        ...
        vm.prank(admin);
        vm.expectEmit(false, false, false, true);
        emit IZaseonUpgradeTimelock.MinSignaturesUpdated(5, 3);
        timelock.confirmMinSignatures();
    ...
    function test_RevertConfirmMinSignatures_TooEarly() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ZaseonUpgradeTimelock.MinSignaturesChangeNotReady.selector,
                block.timestamp + 48 hours
            )
        );
        timelock.confirmMinSignatures();
    ...
    function test_CancelMinSignaturesChange() public {
        ...
        vm.prank(admin);
        vm.expectEmit(false, false, false, true);
        emit ZaseonUpgradeTimelock.MinSignaturesChangeCancelled(3);
    ...
    function test_RevertConfirmWhenNoPending() public {
        vm.prank(admin);
        vm.expectRevert(
            ZaseonUpgradeTimelock.NoPendingMinSignaturesChange.selector
        );
        timelock.confirmMinSignatures();
    }
    ...
    function test_RevertMinSignaturesZero() public {
        vm.prank(admin);
        vm.expectRevert(IZaseonUpgradeTimelock.MinSignaturesTooLow.selector);
