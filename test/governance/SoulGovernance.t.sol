...
import {SoulGovernance} from "../../contracts/governance/SoulGovernance.sol";

contract SoulGovernanceTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(admin);
        governance = new SoulGovernance(MIN_DELAY, proposers, executors, admin);
    }
