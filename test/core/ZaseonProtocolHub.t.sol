...
/**
 * @title ZaseonProtocolHubTest
 * @notice Comprehensive tests for the central registry hub
 */
contract ZaseonProtocolHubTest is Test {
    ...
    function test_RegisterVerifier() public {
        ...
        IZaseonProtocolHub.VerifierInfo memory info = hub.getVerifierInfo(
            verifierType
        );
    ...
    function test_RevertBatchTooLarge() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IZaseonProtocolHub.BatchTooLarge.selector,
                size,
                50
            )
        );
    ...
    function test_RevertVerifierZeroAddress() public {
        vm.prank(operator);
        vm.expectRevert(
            abi.encodeWithSelector(IZaseonProtocolHub.ZeroAddress.selector)
        );
    ...
    function test_RegisterBridgeAdapter() public {
        ...
        IZaseonProtocolHub.RelayInfo memory info = hub.getRelayInfo(chainId);
