...
/**
 * @title PILIntegrationFuzz
 * @notice Integration fuzz tests for complete transaction flows across PIL Network
 * @dev Tests end-to-end scenarios: deposit->swap->withdraw, cross-chain transfers, etc.
 *
 * Run with: forge test --match-contract PILIntegrationFuzz --fuzz-runs 5000
 */
contract PILIntegrationFuzz is Test {
    /*//////////////////////////////////////////////////////////////
                            CONSTANTS
    //////////////////////////////////////////////////////////////*/
