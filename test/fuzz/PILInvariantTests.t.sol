...
/**
 * @title PILInvariantTests
 * @notice Stateful invariant tests for PIL Network protocol properties
 * @dev Tests cross-contract interactions and global protocol invariants
 *
 * Run with: forge test --match-contract PILInvariantTests --fuzz-runs 1000
 */
contract PILInvariantTests is StdInvariant, Test {
    PILNetworkHandler public handler;

    function setUp() public {
        handler = new PILNetworkHandler();
...
/**
 * @title PILNetworkHandler
 * @notice Handler contract for stateful invariant testing
 */
contract PILNetworkHandler is Test {
    /*//////////////////////////////////////////////////////////////
                            STATE
    //////////////////////////////////////////////////////////////*/
